...
if num >= host.scroll and num < host.scroll+16
{
	...
	if editText = true 
	{	
		drawText(c_black,c_white,x+150,y+2,value)
		
		if caretFlash >= 0
		{
			drawText(c_black,c_white,x+150,y+2,string_copy(value,0,caret)+"|")
		}
		caretFlash--
	...
	{
		drawText(c_black,c_white,x+150,y+2,string_format(value,0,pt))
	}
}
